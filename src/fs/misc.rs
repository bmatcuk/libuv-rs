...
///
/// Be careful in setuid executables. On some platforms the executable path is an arbitrary string
/// that is controlled by the user. On other platforms environment variables are consulted that may
